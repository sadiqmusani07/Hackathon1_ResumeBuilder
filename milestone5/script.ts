...
function generateResume() {
    ...
    const containerShareableLink = document.getElementById('container-shareable-link') as HTMLDivElement;
    ...
    //printWindow.focus();
    //printWindow.print();
    const shareableURL = `${window.location.origin}?username=${username}`;
    containerShareableLink.style.display = 'block';
